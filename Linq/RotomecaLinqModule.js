export const RotomecaEnumerable = (() => {
            ...
            if (Array.isArray(item) || (typeof item[Symbol.iterator] === 'function' && !is_array_like)) return new RotomecaEnumerable(new RotomecaGenerator(item));
                ...
                for (const key in item) {
                    if (Object.prototype.hasOwnProperty.call(item, key)) {
                        ...
                        arr.push(new RotomecaKeyValuePair(key, element));
                    }
                }
                return new RotomecaEnumerable(new RotomecaGenerator(arr));
            } 
...
/* 
############# EXEMPLE OF EXTENDS ############
RotomecaEnumerable.prototype.add = function (item) {
    var generator = function *(gen, item){
    ...
    return RotomecaEnumerable.from(generator(this.generator(), item));
}
